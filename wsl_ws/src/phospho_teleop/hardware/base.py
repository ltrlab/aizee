...
from phospho_teleop.configs import config as cfg
from phospho_teleop.models import BaseRobot, BaseRobotConfig, BaseRobotInfo, Temperature
from phospho_teleop.models.lerobot_dataset import FeatureDetails
from phospho_teleop.hardware import get_sim
from scipy.spatial.transform import Rotation as R  # type: ignore
from phospho_teleop.utils import (
...
class BaseManipulator(BaseRobot):
    ...
    def init_config(self) -> None:
        ...
        if config is not None:
            self.config = config
            logger.success("Loaded config from home directory phospho_teleop.")
            return
    ...
    def get_observation(
        ...
        from phospho_teleop.endpoints.control import (
            signal_ai_control,
