...
from phospho_teleop.hardware.base import BaseRobot
from loguru import logger

from phospho_teleop.models import BaseRobotConfig, RobotConfigStatus
...
class RemotePhosphobot(BaseRobot):
    ...
    def __init__(self, ip: str, port: int, robot_id: int, **kwargs):
        """
        Initialize connectio to phospho_teleop.
